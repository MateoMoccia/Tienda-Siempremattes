...
const Inicio = () => {
  ...
  // Productos para la página de inicio, sin mostrar precio ni botón
  const productos = [
    {
      imagen: '/catalogo-siempremates//img/Matera1.png',
      nombre: 'Matera 100% cuero negra',
      precio: 0,  // El precio no se mostrará
    },
    {
      ...
      <article className="productos">
        {productos.map((producto, index) => (
          <ProductoRnd
            ...
            sinExtras={true}  // Ocultar precio y botón en la página de inicio
          />
        ))}
      </article>
